 ...
 */
final class Version20200318202140 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE soortactiviteit ADD beschrijving LONGTEXT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE activiteit CHANGE soort_id soort_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE soortactiviteit DROP beschrijving');

 ...
 */
final class Version20200318210410 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE activiteit ADD max_leeftijd INT NOT NULL, CHANGE soort_id soort_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE activiteit DROP max_leeftijd, CHANGE soort_id soort_id INT DEFAULT NULL');
